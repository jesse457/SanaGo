<div x-data="{
    ...
    <main>
        ...
        <section class="py-24 bg-white/40 dark:bg-black/20 backdrop-blur-sm">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-16 reveal-on-scroll">
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">{{ __('features.roles_title') }}</h2>
                    <p class="mt-4 text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">{{ __('features.roles_subtitle') }}</p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div @click="activeRole = activeRole === 'admin' ? null : 'admin'" class="reveal-on-scroll delay-100 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white">{{ __('features.admin_title') }}</h3>
                        </div>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.admin_desc') }}</p>
                        <div x-show="activeRole === 'admin'" x-transition class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            <ul class="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                @foreach(__('features.admin_features') as $feature)
                                <li>• {{ $feature }}</li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div @click="activeRole = activeRole === 'doctor' ? null : 'doctor'" class="reveal-on-scroll delay-200 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white">{{ __('features.doctor_title') }}</h3>
                        </div>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.doctor_desc') }}</p>
                        <div x-show="activeRole === 'doctor'" x-transition class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            <ul class="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                @foreach(__('features.doctor_features') as $feature)
                                <li>• {{ $feature }}</li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div @click="activeRole = activeRole === 'receptionist' ? null : 'receptionist'" class="reveal-on-scroll delay-300 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white">{{ __('features.receptionist_title') }}</h3>
                        </div>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.receptionist_desc') }}</p>
                        <div x-show="activeRole === 'receptionist'" x-transition class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            <ul class="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                @foreach(__('features.receptionist_features') as $feature)
                                <li>• {{ $feature }}</li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div @click="activeRole = activeRole === 'lab' ? null : 'lab'" class="reveal-on-scroll delay-100 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white">{{ __('features.lab_title') }}</h3>
                        </div>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.lab_desc') }}</p>
                        <div x-show="activeRole === 'lab'" x-transition class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            <ul class="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                @foreach(__('features.lab_features') as $feature)
                                <li>• {{ $feature }}</li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div @click="activeRole = activeRole === 'pharmacist' ? null : 'pharmacist'" class="reveal-on-scroll delay-200 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white">{{ __('features.pharmacist_title') }}</h3>
                        </div>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.pharmacist_desc') }}</p>
                        <div x-show="activeRole === 'pharmacist'" x-transition class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            <ul class="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                @foreach(__('features.pharmacist_features') as $feature)
                                <li>• {{ $feature }}</li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div @click="activeRole = activeRole === 'nurse' ? null : 'nurse'" class="reveal-on-scroll delay-300 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl cursor-pointer transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <h3 class="text-xl font-bold text-slate-900 dark:text-white">{{ __('features.nurse_title') }}</h3>
                        </div>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.nurse_desc') }}</p>
                        <div x-show="activeRole === 'nurse'" x-transition class="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                            <ul class="space-y-2 text-sm text-slate-700 dark:text-slate-300">
                                @foreach(__('features.nurse_features') as $feature)
                                <li>• {{ $feature }}</li>
                                @endforeach
                            </ul>
                        </div>
        ...
        <section class="py-24">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-16 reveal-on-scroll">
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">{{ __('features.system_title') }}</h2>
                    <p class="mt-4 text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">{{ __('features.system_subtitle') }}</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="reveal-on-scroll delay-100 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">{{ __('features.feature_multilang_title') }}</h3>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.feature_multilang_desc') }}</p>
                    </div>
                    ...
                    <div class="reveal-on-scroll delay-200 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">{{ __('features.feature_security_title') }}</h3>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.feature_security_desc') }}</p>
                    </div>
                    ...
                    <div class="reveal-on-scroll delay-300 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">{{ __('features.feature_notifications_title') }}</h3>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.feature_notifications_desc') }}</p>
                    </div>
                    ...
                    <div class="reveal-on-scroll delay-100 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">{{ __('features.feature_profiles_title') }}</h3>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.feature_profiles_desc') }}</p>
                    </div>
                    ...
                    <div class="reveal-on-scroll delay-200 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">{{ __('features.feature_feedback_title') }}</h3>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.feature_feedback_desc') }}</p>
                    </div>
                    ...
                    <div class="reveal-on-scroll delay-300 bg-white dark:bg-slate-800/60 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-xl">
                        ...
                        <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-3">{{ __('features.feature_audit_title') }}</h3>
                        <p class="text-slate-600 dark:text-slate-300">{{ __('features.feature_audit_desc') }}</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-24">
            <div class="max-w-5xl mx-auto px-6">
                <div class="relative rounded-[2.5rem] bg-gradient-to-br from-blue-600 to-indigo-700 overflow-hidden px-6 py-16 sm:px-12 sm:py-20 text-center shadow-2xl shadow-blue-900/40 reveal-on-scroll">
                    ...
                    <h2 class="relative text-3xl font-bold tracking-tight text-white sm:text-5xl mb-6">{{ __('features.cta_title') }}</h2>
                    <p class="relative text-xl text-blue-100 max-w-2xl mx-auto mb-10">{{ __('features.cta_subtitle') }}</p>
