    ...
    <main class="w-full max-w-md">
      <section class="bg-white/90 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 sm:p-10 border border-gray-200 dark:border-gray-700">
        <header class="flex flex-col items-center mb-6">
          ...
          <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white text-center">Reset Password</h1>
          <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 text-center">Set a new password for your account.</p>
        </header>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                required
                readonly
                class="block w-full pl-12 pr-4 py-3 border rounded-lg shadow-sm placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-500 transition-colors duration-200 cursor-not-allowed opacity-70" />
            </div>
            @error('email')
