    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 ">
                {{ __('Manage your account settings, personal information, and view assigned shifts.') }}
            </p>
        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-700 overflow-hidden">
                    <div class="p-8 flex flex-col items-center text-center">
                        ...
                        <span class="inline-flex items-center rounded-full bg-indigo-50 px-2.5 py-0.5 text-xs font-medium text-indigo-700 ring-1 ring-inset ring-indigo-700/10 dark:bg-indigo-900/30 dark:text-indigo-400 mt-2">
                            {{ ucfirst(__(Auth::user()->role ?? 'User')) }}
                        </span>
                        ...
                        <div class="w-full mt-8 border-t border-gray-100 dark:border-gray-700 pt-6">
                            <h3 class="text-sm font-semibold text-gray-900 dark:text-white text-left mb-4 uppercase tracking-wider">{{ __('Contact Details') }}</h3>
                            <ul class="space-y-4 text-sm">
                                <li class="flex items-start justify-between">
                                    <span class="flex items-center text-gray-500 dark:text-gray-400">
                                        <x-heroicon-o-phone class="w-4 h-4 mr-2" /> {{ __('Phone') }}
                                    </span>
                                    <span class="font-medium text-gray-900 dark:text-white">{{ $phone_number ?? __('Not provided') }}</span>
                                </li>
                                <li class="flex items-start justify-between">
                                    <span class="flex items-center text-gray-500 dark:text-gray-400">
                                        <x-heroicon-o-map-pin class="w-4 h-4 mr-2" /> {{ __('Address') }}
                                    </span>
                                    <span class="font-medium text-gray-900 dark:text-white text-right max-w-[150px] truncate">{{ $address ?? __('Not provided') }}</span>
                                </li>
                                <li class="flex items-start justify-between">
                                    <span class="flex items-center text-gray-500 dark:text-gray-400">
                                        <x-heroicon-o-calendar-days class="w-4 h-4 mr-2" /> {{ __('Joined') }}
                                    </span>
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        @else
                            <div class="text-center py-6">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('No upcoming shifts scheduled.') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-700 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Personal Information') }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Update your personal details and contact information.') }}</p>
                    </div>
                    ...
                    <div class="p-6 md:p-8">
                        <form wire:submit.prevent="updateProfile" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {{-- Phone --}}
                            <div>
                                <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('Phone Number') }}</label>
                            ...
                            {{-- Address --}}
                            <div>
                                <label for="address" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('Residential Address') }}</label>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200/60 dark:border-gray-700 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Security') }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Ensure your account uses a long, random password to stay secure.') }}</p>
                    </div>
                    ...
                    <div class="p-6 md:p-8">
                        <form wire:submit.prevent="updatePassword" class="space-y-5 max-w-lg">
                            ...
                            <div>
                                <label for="new_password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('New Password') }}</label>
                            ...
                            <div>
                                <label for="new_password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('Confirm New Password') }}</label>
