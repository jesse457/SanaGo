                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">Your thoughts are important! Tell
                                us what you think to help us improve.</p>
                        </div>
                        <span
                    ...
                    <form wire:submit="submit" class="p-6 sm:p-8 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-1.5">
                                <label for="category"
                                    class="block text-sm font-bold text-slate-700 dark:text-slate-300">Which part of the
                        ...
                        <div class="space-y-1.5">
                            <label for="message"
                                class="block text-sm font-bold text-slate-700 dark:text-slate-300">Tell us what happened
