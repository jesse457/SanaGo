    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar py-4 space-y-1">
        ...
        <ul class="space-y-1 px-3">
            @php
                ...
                $menuItems = [
                    ['route' => 'receptionist.dashboard', 'icon' => 'home', 'label' => __('receptionist.dashboard_title') ?? 'Dashboard'],
                    ['route' => 'receptionist.appointments', 'icon' => 'calendar', 'label' => __('admin.shifts_bar') ?? 'Appointments'],
                    ['route' => 'receptionist.patients', 'icon' => 'users', 'label' => __('admin.revenue_report_bar') ?? 'Patients'],
                    ['route' => 'receptionist.checkin', 'icon' => 'users-plus', 'label' => __('admin.user_management_bar') ?? 'Patient Check-in/Admit'],
                    ['route' => 'receptionist.feedback-history', 'icon' => 'clock', 'label' => __('admin.settings_bar') ?? 'FeedBacks'],
