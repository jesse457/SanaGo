                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm text-gray-400 md:ms-2 dark:text-gray-200">{{ __('doctor.profile') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div
            ...
            <p class="text-md text-blue-600 dark:text-blue-400 font-medium mb-3">
                {{ ucfirst(Auth::user()->role ?? __('doctor.user')) }}</p>
            ...
            <div class="mt-6 w-full text-left border-t border-gray-200 dark:border-gray-700 pt-6">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-3">{{ __('doctor.quick_info') }}</h3>
                <div class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                    <p class="flex items-center"><x-heroicon-o-phone class="w-5 h-5 mr-2 text-gray-500" /> {{ __('doctor.phone') }}:
                        <span class="ml-auto font-medium">{{ $phone_number ?? 'N/A' }}</span>
                    </p>
                    <p class="flex items-center"><x-heroicon-o-map-pin class="w-5 h-5 mr-2 text-gray-500" /> {{ __('doctor.address') }}:
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-6 border-b pb-3">{{ __('doctor.personal_information') }}
                </h3>
                <form wire:submit.prevent="updateProfile" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="name"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.name') }}</label>
                        ...
                        <div>
                            <label for="email"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.email') }}</label>
                        ...
                        <div>
                            <label for="phone"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.phone') }}</label>
                        ...
                        <div>
                            <label for="address"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.address') }}</label>
                        ...
                        <div class="col-span-2 flex justify-end">
                            <button type="submit"
                                class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">{{ __('doctor.update_profile') }}</button>
                        </div>
                </form>
            </div>
            ...
            {{-- Change Password --}}
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-6  pb-3">{{ __('doctor.change_password') }}</h3>
                <form wire:submit.prevent="updatePassword" class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.current_password') }}
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.new_password') }}
                                </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('doctor.confirm_password') }}
                                </label>
                        ...
                        <div class="flex justify-end">
                            <button type="submit"
                                class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">{{ __('doctor.update_password') }}</button>
                        </div>
                </form>
            </div>
        </div>
