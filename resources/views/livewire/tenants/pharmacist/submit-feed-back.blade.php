                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('pharmacist.feedbacks') }}" wire:navigate
                    ...
                    <form wire:submit="submit" class="p-6 sm:p-8 space-y-8" >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-1.5">
                                <label for="subject" class="block text-sm font-bold text-slate-700 dark:text-slate-300">{{ __('What is this about?') }} <span class="text-red-500">*</span></label>
                            ...
                            {{-- Category --}}
                            <div class="space-y-1.5">
                                <label for="category" class="block text-sm font-bold text-slate-700 dark:text-slate-300">{{ __('Which part of the system?') }} <span class="text-red-500">*</span></label>
                                  <select id="category" wire:model.defer="category"
                                    class="block w-full rounded-xl border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-white py-2.5 px-3">
                                   <option value="dashboard">{{ __('Dashboard') }}</option>
                                    <option value="dispense-medication">{{ __('Dispense Medication') }}</option>
                                    <option value="manage-drugs">{{ __('Manage Drugs') }}</option>
                                    <option value="create-new-drugs">{{ __('Create New Drugs') }}</option>
                        ...
                        {{-- Message --}}
                        <div class="space-y-1.5">
                            <label for="message" class="block text-sm font-bold text-slate-700 dark:text-slate-300">{{ __('Tell us what happened') }} <span class="text-red-500">*</span></label>
