    ...
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
            ...
            <div class="col-span-2 lg:col-span-2">
                ...
                <p class="text-slate-500 dark:text-slate-400 max-w-sm mb-8 leading-relaxed">Transforming healthcare management with intelligent solutions. Secure, scalable, and simple operational control.</p>
                <!-- Socials -->
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                    <li><a wire:navigate href="{{ route('features') }}" class="hover:text-blue-600 transition-colors">Features</a></li>
                    <li><a href="#" class="hover:text-blue-600 transition-colors">Solutions</a></li>
                    <li><a wire:navigate href="{{ route('pricing') }}" class="hover:text-blue-600 transition-colors">Pricing</a></li>
                    <li><a wire:navigate href="{{ route('book-demo') }}" class="hover:text-blue-600 transition-colors">Book a Demo</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                    <li><a wire:navigate href="{{ route('about') }}" class="hover:text-blue-600 transition-colors">About</a></li>
                    <li><a wire:navigate href="{{ route('career') }}" class="hover:text-blue-600 transition-colors">Careers</a></li>
                    <li><a wire:navigate href="{{ route('blog') }}" class="hover:text-blue-600 transition-colors">Blog</a></li>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                    ...
                    <li><a href="#" class="hover:text-blue-600 transition-colors">Terms</a></li>
                    <li><a href="#" class="hover:text-blue-600 transition-colors">DPA</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p class="text-slate-500 dark:text-slate-400">&copy; {{ date('Y') }} SanaGo. All rights reserved.</p>
